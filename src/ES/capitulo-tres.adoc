...
In terms of controlling body fat, the difference between simple and complex carbohydrates is the speed at which they enter the blood as glucose and the total amount of insulin that is released. As we will see, elevated insulin levels impact fat storage. While 200 calories of yams will illicit less insulin than 200 calories of a refined food such as pretzels or fat free potato chips, there is another aspect of complex carbs to consider. The more refined, processed or cooked the complex carbohydrate, the faster it breaks down into glucose which, in turn, effects insulin levels. Whole grain bread is processed

en pan blanco. El arroz integral se transforma en arroz blanco y el maíz en copos de maíz. Una patata "asada" en un microondas, en general, es más firme que una asada en un horno convencional y el puré de patatas es claramente menos firme o "más blando" que una patata asada. ¿Cuál es el problema? Cuanto más procesado esté el carbohidrato y más blando sea, más fácil será digerirlo y cuanto más fácil sea digerirlo, mayor será el pico de insulina.

**REVISIÓN**

- 1) Los dos tipos de hidratos de carbono son los simples y los complejos.
- 2) Los simples suelen ser "artificiales". Por ejemplo, las tartaletas, los pretzels o los caramelos sin grasa.
- 3) Los complejos son "más naturales". Por ejemplo, los boniatos, el arroz salvaje y las patatas.
- 4) Los carbohidratos simples provocan más insulina que los complejos.
- 5) La insulina elevada influye en el almacenamiento de grasa.

[.text-center]
**La conexión de fibra**

La fibra se ha promocionado como una herramienta prometedora para el control del peso, y con razón. La fibra se denomina "una sustancia alimentaria no digerible" común a los alimentos ricos en carbohidratos. Mientras que las principales categorías de hidratos de carbono se dividen en simples y complejos, los hidratos de carbono con fibra constituyen un tercer grupo independiente. Los carbohidratos de tipo fibra incluyen verduras crujientes y difíciles de masticar que no sólo son extremadamente bajas en calorías, ¡sino que esencialmente no tienen calorías! Esto se debe a que el organismo carece de las enzimas necesarias para descomponer la fibra y obtener las calorías que contiene el alimento. ¿El resultado de comer verduras con fibra? Pasan directamente por el organismo sin aportar calorías. De hecho, los hidratos de carbono con fibra pueden costarle calorías. He aquí cómo. Cuando comes, al cuerpo le cuesta calorías empezar a trabajar en los alimentos para descomponerlos y digerirlos. Cuando usted come una taza de verduras, el cuerpo trabaja para obtener el combustible de los alimentos. En el intento de obtener combustible de las verduras, se gastan calorías. Otra forma de verlo es que el cuerpo utiliza su propio combustible, por lo que se "gasta" energía intentando obtener combustible de los alimentos consumidos. Sin embargo, las verduras no son más que alimentos que no producen energía. No producen energía utilizable para el cuerpo y el cuerpo humano es incapaz de utilizar la fibra como combustible. El efecto neto: se queman calorías comiendo verduras. Además, estos carbohidratos no afectan a los niveles de insulina.

**Entre las verduras con fibra más comunes se encuentran:**

[width="100%",cols="33.33%,33.33%,33.33%",options="header"]
|===
| Espárragos | Judías verdes | Calabaza (espaguetis)
| Brócoli | Lechuga | Calabaza (verano)
| Col | Setas | Castañas de agua
| Coliflor | Okra | Judías cera
| Apio | Rábano | Calabacín
| Berenjena | Espinacas |
|===

Evidentemente, las verduras son beneficiosas en el sentido de que es muy difícil "comerlas en exceso" y hacen que uno se sienta satisfecho. A una persona puede resultarle relativamente fácil engullir 3 tazas de pasta, que aportan 450 calorías y aproximadamente 135 gramos de hidratos de carbono, pero probablemente le resulte más difícil o menos placentero engullir 3 tazas de brócoli, que aportan 120 calorías y 30 gramos de hidratos de carbono, todos ellos inabsorbibles al estar "encerrados" en la fibra, el "carbohidrato no digerible" de la naturaleza.

El beneficio añadido de los carbohidratos tipo fibra es su efecto sobre la insulina. Cuando los carbohidratos complejos o simples se combinan con verduras de tipo fibra, se retrasa la velocidad a la que la glucosa de los carbohidratos complejos o simples "llega" al torrente sanguíneo. En efecto, añadir verduras a un carbohidrato complejo o simple ralentiza la velocidad a la que la glucosa llega a la sangre. Si la glucosa entra en la sangre a un ritmo más lento, el páncreas responde produciendo menos insulina. Una comparación sencilla: 200 calorías de arroz frente a 200 calorías de arroz mezclado con una taza de coliflor. La comida a base de arroz provocará una mayor explosión de insulina que la combinación de arroz y verduras. Las verduras con fibra actúan como un agente "liberador de tiempo" natural de los carbohidratos simples o complejos.

y es este efecto de liberación de tiempo el que influye en los niveles de insulina.

Las pequeñas cantidades de fibra, o la falta de fibra, en muchos carbohidratos complejos afectan a la secreción de insulina. El arroz salvaje contiene pequeñas cantidades de fibra en comparación con el arroz blanco blanqueado y el verdadero pan integral contiene más fibra que el pan blanco. Aunque todos se consideran hidratos de carbono complejos debido a su larga red ramificada de moléculas de glucosa unidas entre sí, se digieren a diferentes velocidades debido a su contenido variable en fibra. El arroz blanco se digerirá más rápido que el arroz salvaje y, por tanto, elevará los niveles de insulina. Del mismo modo, el pan blanco, que carece de fibra, se digiere mucho más rápido que el pan integral. ¿El resultado neto? El pan blanco crea una mayor respuesta de insulina que el pan integral y cuanto mayor es la respuesta de insulina, mayor es el efecto sobre el complejo sistema que te mantiene gordo.
...
- 1 Su valor calórico.
- 2 La capacidad del organismo para "acceder" a esas calorías.
- 3 Su efecto sobre los niveles de insulina.

[.text-center]
**Dinámica del azúcar, la insulina y las grasas**

La insulina tiene efectos positivos y negativos en el organismo. En lo que respecta al control de la grasa corporal, el éxito final depende de la ingesta total de calorías y de las hormonas afectadas por los tipos de calorías que ingerimos.

Los niveles elevados de insulina para la persona que espera controlar la grasa corporal son, posiblemente, tan perjudiciales como la ingesta calórica total. Los niveles altos o elevados de insulina son el resultado de comer en exceso carbohidratos, ya sean carbohidratos complejos o simples. Cuando comes carbohidratos en exceso, aumentas la cantidad de glucosa en sangre por encima de 110, lo que promueve una explosión de insulina que arrastra el exceso de azúcar fuera de la sangre permitiendo que los niveles de glucosa vuelvan a la normalidad, alrededor de 70 a 110.

Esta es la parte difícil. Es posible mantenerse dentro de los límites calóricos y crear un entorno en el que los niveles de insulina

Los niveles elevados de insulina también tienen otros efectos metabólicos interesantes, ya que favorecen el almacenamiento de grasa e impiden su liberación.

de los ácidos grasos almacenados en el tejido adiposo. Cuando los niveles de insulina aumentan, se desencadena la liberación de una enzima llamada lipoproteína lipasa (LPL). La LPL frena las células adiposas y evita que se descompongan para ser utilizadas como combustible. En efecto, podríamos decir que la LPL bloquea la descomposición de las células adiposas y que la LPL se estimula con niveles elevados de insulina.

El cuerpo siempre utiliza una combinación de fuentes de energía cuando está en reposo. La grasa es la principal fuente de energía en un cuerpo en reposo. En segundo lugar, muy por detrás, se encuentra la glucosa. Parte de esta grasa proviene de la grasa de la dieta que consumimos, mientras que la mayor parte procede de las células adiposas. Si los niveles de insulina están crónicamente elevados debido a un consumo diario de calorías superior al necesario o a una ingesta calórica moderada pero rica en carbohidratos simples y pobre en fibra, las células adiposas quedan aisladas y no pueden utilizarse como combustible. De hecho, la insulina es tan eficaz a la hora de aislar las células adiposas que incluso quienes realizan ejercicio aeróbico intenso tendrán dificultades para perder grasa de forma significativa, si no es que les resulte casi imposible, a menos que se controlen los niveles de insulina.

*REVISIÓN*

- 1) Los niveles elevados de insulina se deben a un exceso de calorías.
- 2) Los niveles elevados de insulina se deben al consumo de carbohidratos simples con poca o ninguna fibra, incluso si el aporte calórico total no es excesivo.
- 3) Cuando los depósitos de glucógeno de los músculos y el hígado están llenos, los niveles elevados de insulina provocan que los hidratos de carbono se almacenen en forma de grasa corporal.
- 4) Los niveles elevados de insulina aumentan la lipoproteína lipasa, lo que impide que los ácidos grasos salgan de las células adiposas.

Curiosamente, el páncreas, que se encarga de liberar insulina, también libera una hormona opuesta llamada glucagón. Su función está relacionada con la de la insulina: regula los niveles de glucosa en sangre. Mientras que la insulina elimina la glucosa de la sangre cuando los niveles de glucosa aumentan, el glucagón aumenta los niveles de glucosa en sangre cuando estos bajan. Cuando la ingesta calórica es baja o cuando hay una carencia temporal de carbohidratos en la dieta, los niveles de glucosa se acercan al nivel de 70 o caen por debajo de 70. En ese momento, se libera glucagón. El glucagón recurre a los depósitos de glucosa, el hígado y los músculos, para suministran glucosa a la sangre. El glucagón estimula a los músculos y al hígado para que devuelvan glucosa a la sangre cada vez que bajan los niveles de glucosa. Podemos decir que el glucagón se opone a la insulina. Aunque ambas ayudan a mantener los niveles de azúcar en sangre dentro de un rango normal de 70-110, la insulina es una almacenadora de azúcar, mientras que el glucagón libera el azúcar de los lugares de almacenamiento. Recordemos que la insulina activa la lipoproteína lipasa (LPL), lo que hace que las células adiposas se mantengan llenas de grasa. El *glucagón* hace lo contrario: *promueve la liberación de la lipasa sensible a las hormonas (HSL), que actúa sobre las células adiposas para liberar ácidos grasos*, vertiéndolos en la sangre donde pueden utilizarse como combustible. El cuerpo siempre libera una mezcla de insulina y glucagón cuando se ingieren alimentos que contienen una combinación de carbohidratos, proteínas y grasas. Cuando se ingieren carbohidratos solos, la principal hormona secretada es la insulina. En una comida mixta, compuesta por carbohidratos y proteínas, la respuesta hormonal inicial es un aumento de los niveles de insulina; sin embargo, si la comida contiene al menos 15-20 gramos de proteína, los niveles de insulina no se dispararán, ya que la proteína estimulará la liberación de glucagón. La pequeña liberación de glucagón iniciada por las proteínas arrastra los niveles de insulina hacia abajo. Piensa en la insulina como agua caliente y en el glucagón como agua fría. Añadir un poco de agua fría a una bañera de agua caliente hace bajar la temperatura, y *añadir glucagón a la insulina reduce los niveles de insulina y su capacidad para almacenar grasa*. Entre comidas, cuando los niveles de glucosa en sangre comienzan a descender, entra en juego el glucagón. Una dieta alta en calorías o una ingesta calórica que, aunque no sea tan elevada, sea abundante en carbohidratos simples y carece de fibra mantendrá los niveles de insulina crónicamente altos, lo que, a su vez, suprime los niveles de glucagón. El efecto neto es que la grasa corporal se va depositando continuamente.

Los niveles elevados de insulina pueden controlarse incluyendo verduras en la dieta diaria, ya que estas ralentizan la descomposición y la digestión de los carbohidratos en glucosa en sangre, modificando así la producción de insulina. Una ingesta adecuada de proteínas mantendrá altos los niveles de glucagón, lo que contrarrestará los niveles más elevados de insulina.

[.text-center]
*Grasas alimentarias: la relación con la grasa corporal*

Las grasas alimentarias, junto con los hidratos de carbono y las proteínas, constituyen los tres macronutrientes. Durante los últimos quince años aproximadamente, las personas que siguen una dieta han evitado las grasas debido a los factores mencionados anteriormente. Gramo a gramo, aportan más calorías que los carbohidratos o las proteínas, no ocupan mucho espacio en el estómago, por lo que es fácil comer de más, y el cuerpo es bastante eficiente a la hora de aprovechar el verdadero valor calórico de las grasas alimentarias. Recordemos que, a diferencia de las calorías derivadas de las proteínas, que son absorbibles en un 80 %, o de las que se encuentran en los carbohidratos, que son absorbibles en aproximadamente un 90 %, las calorías de las grasas alimentarias son absorbibles en un 97 %. Es decir, cuando se consumen 100 calorías de grasa, el cuerpo obtiene 97 de ellas.

Históricamente, en Estados Unidos, nuestro consumo de grasas alimentarias ha aumentado en los últimos 50 años, al igual que nuestro consumo de carbohidratos refinados y simples. Al mismo tiempo, nuestro consumo de carbohidratos complejos más naturales ha disminuido y nuestro consumo de verduras se ha desplomado lamentablemente. Eso, combinado con una menor actividad física y un estilo de vida más sedentario, ha destruido por completo nuestro nivel de salud y forma física. Por cada nuevo gimnasio que surge, hay un centenar de niños pequeños con sobrepeso u obesidad.

Cuando se consumen grasas alimentarias, el cuerpo no puede transportar todo ese conjunto a través de la sangre. Las grasas de los alimentos deben descomponerse en sus componentes básicos: ácidos grasos y glicerol. Los ácidos grasos proporcionan energía a los músculos en reposo y durante el ejercicio aeróbico, y el glicerol puede, tras una larga cadena de procesos, reconvertirse en glucosa. Esta glucosa puede influir, en pequeña medida, en la cantidad total de glucosa en sangre.

Los mecanismos de almacenamiento de grasa corporal dependen del aporte calórico total para generar nueva grasa corporal y de la relación dinámica entre la grasa de la dieta y la insulina producida a partir de los carbohidratos. Si bien la insulina tiene la capacidad de almacenar carbohidratos en forma de glucógeno o de dirigirlos hacia las células adiposas, lo que influye en la acumulación de grasa corporal, y de liberar lipoproteína lipasa, que esencialmente impide que las células adiposas se descompongan, es la influencia más importante en la acumulación de grasa corporal adicional radica en su capacidad para estimular la absorción de la grasa de la dieta por parte de las células adiposas. En pocas palabras, una ingesta elevada de grasas en la dieta, en presencia de insulina, garantiza prácticamente que la grasa de la dieta no solo «llegue» a las células adiposas, sino que se almacene rápidamente para hacer que estas se hagan más grandes. Al igual que la insulina es el «desencadenante» que pone en marcha la eliminación de la glucosa de la sangre y su conversión en glucógeno o grasa, es el principal desencadenante que permite que las células adiposas se «abran» y dejen que se almacene la grasa alimentaria adicional. La combinación letal: azúcares simples o una cantidad masiva de carbohidratos complejos y grasa alimentaria.

[.text-center]
*INSULINA + Grasa alimentaria = Grasa corporal*

En ambos casos, los niveles elevados de insulina transportan los ácidos grasos a las células adiposas, lo que hace que engordes. Una vez allí, la grasa permanece en ese lugar, ya que los niveles elevados de insulina «bloquean y sellan» las células adiposas, lo que dificulta que el cuerpo las utilice como combustible.

[.text-center]
*No todas las grasas son iguales*

Existen diferentes tipos de grasas alimentarias y cada una de ellas ejerce propiedades distintas en el organismo. Las grasas saturadas son sólidas a temperatura ambiente, mientras que las insaturadas son líquidas a temperatura ambiente. Todas las fuentes de grasa de origen animal, como las que se encuentran en las carnes, la piel del pollo, los huevos y los productos lácteos (a menos que sean desnatados), contienen grasas saturadas. Las grasas saturadas, consumidas en exceso, son un enemigo de la buena salud, ya que una ingesta crónicamente elevada puede provocar cicatrices en las arterias del sistema cardiovascular. Esto, a su vez, provoca una obstrucción leve de las paredes arteriales. Además, un consumo elevado de grasas saturadas altera la consistencia de la sangre, haciéndola más espesa y viscosa. Una sangre más espesa y unas arterias estrechadas suponen una mayor carga para el corazón, obligándolo a bombear cada vez con más fuerza y, por lo general, con mayor frecuencia para «empujar» una sustancia más espesa a través de un sistema tubular más estrecho. Es como succionar agua con una pajita frente a succionar un batido con un palillo para remover el café. Requiere muchísimo más esfuerzo.